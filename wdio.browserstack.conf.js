...
export const config = {
  ...
  baseUrl: `https://forms-acceptance-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `forms-acceptance-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `forms-acceptance-tests-${process.env.ENVIRONMENT}`
        },

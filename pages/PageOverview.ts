...
export class PageOverview extends PageBase {
  ...
  constructor(page: Page) {
    ...
    this.repeaterCheckbox = page.getByLabel(
    ...
    this.questionSetNameInput = page.getByLabel(
    ...
    this.conditionsTitle = page.getByRole('heading', {
      name: 'Control who can see this page based on previous answers'
    })
    this.noConditionsMessage = page.getByText(
      'No conditions available to use. Create a new condition.'
    )
    this.conditionsManagerLink = page.getByRole('link', {
      name: 'conditions manager'
    })
    this.createNewConditionLink = page.getByRole('link', {
      name: 'Create new condition'
    })
    this.downloadFormButton = page.getByRole('button', {
      name: 'Download this form'
    })
    this.reorderPagesButton = page.getByRole('button', {
      name: 'Re-order pages'
    })
    this.saveConditionButton = page.getByRole('button', {
      name: 'Save condition'
    })
  }
  ...
  async configurePageHeadingAndGuidance(
    pageHeading: string,
    guidanceText: string
  ) {

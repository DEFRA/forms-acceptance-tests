...
export class PageListingPage {
  ...
  constructor(page: Page) {
    ...
    this.pageSummaryCards = page.locator(
      '.govuk-summary-card.pages-panel-left-standard'
    )
    this.endPagesHeader = page.getByRole('heading', {
      level: 2,
      name: /End pages/
    })
  }
  ...
  async getPageSummaryCardByTitle(title: string): Promise<Locator> {
    return this.page
      .locator('.govuk-summary-card__title', { hasText: title })
      .first()
      .locator('..')
      .locator('..')
      .locator('..')

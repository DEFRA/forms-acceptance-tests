...
test('1.2.1 - should create a new form with short answer field', async ({ formPage, selectQuestionTypePage, pageOverview, selectPageTypePage, editQuestionPage }) => {
  ...
  await editQuestionPage.fillQuestionDetails('What is your full name?', 'Enter your full name', 'Full name');
...
test('1.2.2 - should create a new form with long answer field', async ({ formPage, selectPageTypePage, selectQuestionTypePage, pageOverview }) => {
  // Add a new page
  await formPage.addNewPageButton.click();
  ...
  // Configure the question
  await formPage.createWrittenAnswer('Tell us about yourself', faker.lorem.paragraph());
...
test('1.2.3 - should create a new form with number field', async ({ formPage, selectPageTypePage, selectQuestionTypePage, pageOverview }) => {
...
test('1.2.4 - should create a new form with full date field', async ({ formPage, selectPageTypePage, selectQuestionTypePage, pageOverview }) => {
...
test('1.2.5 - should create a new form with Month Year field', async ({ formPage, selectPageTypePage, selectQuestionTypePage, pageOverview }) => {
...
test('1.2.6 - should create a new form with UK address field', async ({ formPage, selectPageTypePage, selectQuestionTypePage, pageOverview }) => {
...
test('1.2.7 - should create a new form with Phone number field', async ({ formPage, selectPageTypePage, selectQuestionTypePage, pageOverview }) => {
  ...
  // Configure the question
  await formPage.createWrittenAnswer('What is your contact telephone number', 'telephone');

  // Verify success banner
  expect(await pageOverview.verifySuccessBanner('Changes saved successfully'));
});

test('1.2.8 - should create a new form with File Upload field', async ({ formPage, selectPageTypePage, selectQuestionTypePage, pageOverview }) => {
  ...
  // Configure the question
  await formPage.createFileUpload('Proof of address', 'We need proof of address');

  // Verify success banner
  expect(await pageOverview.verifySuccessBanner('Changes saved successfully'));
});

test('1.2.9 - should create a new form with Email field', async ({ formPage, selectPageTypePage, selectQuestionTypePage, pageOverview }) => {
...
test('1.2.10 - should create a new form with Yes/No field', async ({ formPage, selectPageTypePage, selectQuestionTypePage, pageOverview }) => {
...
test('1.2.11 - should create a new form with Checkbox field', async ({ formPage, pageOverview, selectPageTypePage, selectQuestionTypePage, editQuestionPage }) => {
...
test('1.2.12 - should create a new form with Select field', async ({ formPage, pageOverview, selectPageTypePage, selectQuestionTypePage, editQuestionPage }) => {
  // Add a new page
  await formPage.addNewPageButton.click();
...
test('1.2.12 - should create a new form with guidance page', async ({ formPage, pageOverview, selectPageTypePage, selectQuestionTypePage, editQuestionPage, guidancePage }) => {
  // Add a new page
  await formPage.addNewPageButton.click();

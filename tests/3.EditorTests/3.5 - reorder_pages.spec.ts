...
test.skip('should allow re-ordering of pages and display Save button', async ({
  page
}) => {
  ...
  await formPage.goTo()
  const formName =
    'Reorder Test Form ' + Math.random().toString().substring(0, 8)
